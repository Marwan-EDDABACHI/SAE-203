...
// On prépare notre requête SQL pour récupérer tous les articles de la BDD
$requete_brute = "SELECT * FROM article";
// On exécute la requête sur notre base
        ...
        <section class="colonne">
            <section class="liste-articles">
                <?php while ($article = mysqli_fetch_array($resultat_brut)) {
                    // On formate la date récupérée dans la BDD pour qu'elle soit exploitable
                    ...
                    <!--
                     ...
                     -->
                        <a href="article.php?id=<?php echo $article["id"]; ?>" class='article' id="<?php echo $article["id"]; ?>">
                            <div>
                                <img src="<?php echo $article['image']; ?>" alt="Illustration de l'article : <?php echo html_entity_decode($article['titre']); ?>">
                            </div>
                            <section class='textes'>
                                <h2 class='titre'>
                                    <?php echo html_entity_decode($article["titre"]); ?>
                                </h2>
                                <p class='description'>
                                    <?php echo html_entity_decode($article["chapo"]); ?>
                                </p>
            ...
            <a class="jpo-banniere" title="Ouverture dans un nouvel onglet" target="_blank" href="https://www.cyu.fr/salons-journee-portes-ouvertes">
                <img src="ressources/images/logo-cyu-blanc.png" width="200" class="logo" alt="Logo CY Paris Université">
