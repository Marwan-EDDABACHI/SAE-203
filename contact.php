...
if ($formulaire_soumis) {
    if (!empty($_POST["prenom"]) && !empty($_POST["nom"]) && !empty($_POST["message"]) && !empty($_POST["email"]) && !empty($_POST["je_suis"]) && !empty($_POST["telephone"])) {
        ...
        $requete_brute = "
            INSERT INTO message(nom, prenom, contenu, email, telephone, type, date_creation)
            VALUES ('$nom', '$prenom', '$message', '$email', '$telephone', '$type', '$date_formatte')
        ";
    ...
    <main class="conteneur-principal conteneur-1280">
        ...
        <form action="" method="POST" class="formulaire-contact">
            ...
            <article class="champ-conteneur">
                ...
                <input type="tel" class="champ" name="telephone" id="telephone" value="<?php echo $formulaire_a_erreurs ? $_POST["telephone"] : null; ?>">
            </article>
