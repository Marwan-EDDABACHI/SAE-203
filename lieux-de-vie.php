    ...
    <main class="conteneur-principal conteneur-1280">
        ...
        <section>
            ...
            <ul class="liste-lieux">
                <li>
                    <div>
                        <img src="./ressources/images/bu.jpg" alt="Espace de travail de la bibliothèque universitaire" width="522" height="435" style="object-fit: cover;">
                    </div>
                ...
                <li>
                    <div>
                        <img src="./ressources/images/restau.jpg" alt="Cafétéria et espace de restauration du CROUS" width="522" height="435" style="object-fit: cover;">
                    </div>
                    <section class="textes">
                ...
                <li>
                    <div>
                        <img src="./ressources/images/numix.jpg" alt="Réseau des fablabs et espaces d'idéation" width="522" height="435" style="object-fit: cover;">
                    </div>
                    <section class="textes">
